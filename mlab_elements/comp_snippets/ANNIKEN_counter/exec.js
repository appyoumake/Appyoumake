...
document.mlab_code_counter = new function() {
...
this.config = {};
	...
	inc = prompt("SKriv inn onsket inkrementverdi for telleren");
	$(el).find("#counter").val(inc);
    };
...
//TODO: implement check for input from app creator. Must be numeric.      
